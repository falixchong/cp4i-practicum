...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/scenario3-image1.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/scenario3-image2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/openshift-overview.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/scenario3-architecture.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect1.png?raw=true)

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect3.png?raw=true)

3. Open the Integration Console (IBM App connect Enterprise Toolkit -> Open Integration console)

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect4.png?raw=true)

4. IBM ACE console will launch on your screen as below:

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect5.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect6.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect7.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect8.png?raw=true)

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppConnect9.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI1.png?raw=true)

3. You will be prompted to select one option from below, select “Reserve Now”.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI2.png?raw=true)

4. Select one of the choices below as the Purpose of Reservation.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI3.png?raw=true)

5. Describe the purpose and select the geography in which you want to create the cluster

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI4.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI5.png?raw=true)

7. Upon successful creation, you would see the below screen.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI6.png?raw=true)

8. Select “My Reservations” tab --> Cluster should be listed here

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI7.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI8.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CI9.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/createproject1.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/createproject2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EntKey1.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EntKey2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EntKey3.png?raw=true)

4. Upon creation it will appear under your project.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EntKey4.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntInstall1.png?raw=true)

2. Select and click “Install”

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntInstall2.png?raw=true)

3. Ensure to choose your namespace under your project at the time of installation

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntInstall3.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntInstall4.png?raw=true)

5. Click View Operator and scroll down to the end of page to validate status, version and namespace

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntInstall5.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator1.png?raw=true)
  
2. Click and navigate to “Platform Navigator” tab and click “Create PlatformNavigator

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator3.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator4.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator5.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator6.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator7.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/PlatformNavigator.png?raw=true)
 
2. Click “Create Instance” on top left of the page

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CreateInstance-AppConnect.png?raw=true)
 
3. Select Integration Dashboard and click next

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntegrationDashboard.png?raw=true)
 
4. Select either Production or Quick Start --> click next

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntegrationDashboardType.png?raw=true)
 
5. Key-in the details of the environment and proceed to create the dashboard.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntegrationDashboard-Env.png?raw=true)
 
6. Upon successful creation of Integration Dashboard below message will appear on the browser. 

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntegrationDashboard-Final.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/Messging.png?raw=true)
 
2. This will redirect to a Messaging screen as below. Click on Create an instance to create a queue manager.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MessgnScreen.png?raw=true)
 
3. Select “Quick start” option from this screen, and click on Next.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CreateQMngr.png?raw=true)
...
4. Modify the details for your queue manager as below:
   ...
   ![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/Licence.png?raw=true)
  ...
  ![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AvailabilityType.png?raw=true)
 
 
   c. Select “Type of Volume” from the drop down as persistent-claim
 
  ![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/VolumeType.png?raw=true)
 ...
 ![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/QMngrReady.png?raw=true)
 

6. Click on queue name --> It should open up MQ Console

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQConsole.png?raw=true)
 
 
7. Click on  manage --> quickstart to open queue manager

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ChannlQuickStrt.png?raw=true)
 

8. Navigate to Communication --> App Channel --> Click Create 

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CreateAppChnl.png?raw=true)
 
 
9. Click "Next" on the following page 

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/AppChnlStep2.png?raw=true)
 
10. Select "Quick Create" and provide a Channel Name, Channel Type and Description. Once complete, click "Create"

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ChnnelStep3.png?raw=true)
 
 
11. On successful creation, channel will appear under "App Channels"

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ChannelCreated.png?raw=true)
 

12. To edit the configuration of the Channel click "Configuration" as highlighted below - 

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EditConfigChnl.png?raw=true)
 
 
13. It will redirect to open the configurations section of the Channel. Under "Properties" select "SSL"


![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/EditSSLChnl.png?raw=true)
 
 
14. Select "SSL Authentication" to "Optional" and hit "Save"


![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/SSLEditCntd.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP1.png?raw=true)

2. Browse on your local machine to add the MessageFlow_PI.zip file from the Scenario 3 assets as shown below

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP2.png?raw=true)

3. Open the assets into ACE as shown in screenshot below - 

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP3.png?raw=true)

4. Click on finish to import the Project. Your assets are successfully imported.

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP4.png?raw=true)

   This will open child window to enter details of the server. Once completed, hit finish.
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP5.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP6.png?raw=true)

   Click Finish.
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP7.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/scenario3-application-architecture-ace-rest-rest.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/refactor-http-1.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ChangeProperties1.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/refactor-http-2.png?raw=true)

   Save the flow in ACE after replacing the http://localhost:7800
  
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/refactor-http-3.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/refactor-http-4.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/refactor-http-5.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/scenario3-application-architecture-ace-mq.jpg?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HostName.png?raw=true)
 
 
2. Navigate to ACE and open MQ Flow
 
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ACE-MQFlow.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ACEMQ2.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ACEMQ3.png?raw=true)
 

5. Repeat the same configuration for MQOutput

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/ACEMQoutput.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC2.png?raw=true)

2. Browser will display "Display Token" --> Click to get your API Token
   
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC3.png?raw=true)


![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC4.png?raw=true)
   
3. Copy the command captured in the previous step and use it to connect to CLI


![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC6.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC7.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC8.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC9.png?raw=true)

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/MQAC10.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP8.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/HTTP9.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IBMAppConnect.png?raw=true)
 
 2. Create new Integration Server to deploy BAR file for MQ --> Select QuickStart tool kit integration --> Hit Next

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/DeployBAR.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CreateIntServer.png?raw=true)
...
![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/CreateIntServer2.png?raw=true)
 
 5. Hit "Create" and wait until the status of the server has changed to "Ready"

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntServerStatus.png?raw=true)
 
 6. The status changes to "Ready"

![alt text](https://github.com/falixchong/cp4i-practicum/tree/master/images/IntServerReadyStatus.png?raw=true)
